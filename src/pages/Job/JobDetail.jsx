...
const JobDetail = () => {
  ...
  const fetchRecommendations = async (titleValue) => {
    try {
          ...
          <div className="col w-100">
            ...
            <div className="row mt-3 mb-3 shadow p-3">
              <div className="col w-100">
                ...
                <div className="row">
                  <div className="col">
                    Số lượng tuyển : {job.so_luong} người
                  </div>
                  <div className="col">
            ...
            <div className={`row mt-1 mb-4 shadow p-3`}>
              <div>
                ...
                <div className="row">
                  <button
                    className="btn btn-primary"
                    // onClick={() => handleSearch(job?.vi_tri)}
                  ...
                  <div className="mt-3">
                    {!recommendations || recommendations.length === 0 ? (
                      <p>No recommend found</p>
                    ) : (
                      <ul>
                        {recommendations.map((jobTitle, index) => (
                          <li key={index}>{jobTitle}</li>
                        ))}
                      </ul>
                    )}
                  </div>
